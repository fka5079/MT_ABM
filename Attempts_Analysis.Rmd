...
boxplot(errors$X0, errors$X1, errors$X2, errors$X3, errors$X4, errors$X5, errors$X6, errors$X7, errors$X8,
        names = c('Step 1', 'Step 2', 'Step 3', 'Step 4', 'Step 5', 'Step 6', 'Step 7', 'Step 8', 'Step 9'),
        col = c('Brown', 'Red', 'Purple', 'Black', 'Green', 'Yellow', 'Orange', 'Pink', 'Blue'),
        ylab ='Number of Errors',
        main = 'Number of Errors for Each Step Over 100 Iterations')
